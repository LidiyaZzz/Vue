<template>
    <div class="article">
            <h2>Planning is the process of setting goals, defining strategies,</h2>            
            <div class="article__data">
              <p>23 December,2022</p> 
              <p>Interior / Home / Decore</p>
            </div><!-- /.project__data -->
            <p>In business, strategic planning is crucial for setting long-term goals, allocating resources, and adapting to changing market conditions. It involves assessing strengths, weaknesses, opportunities, and threats (SWOT analysis), defining a vision and mission, and formulating strategies to achieve competitive advantage and sustainable growth.</p>
            ...
            <div class="article__quotes">
              ...
              <h3><i>The details are not the details. They make the design.</i></h3>      
            ...
            <div class="article__img">
              <img class="img" src="../../assets/img/blogDetails/blogDetails_8.jpg" alt="">
            </div><!-- /.blogPost__img -->           
            <p>Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</p>
