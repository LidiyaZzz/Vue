<template>
    <div class="article">
            <h2>Molestiae, adipisci quo soluta laboriosam porro voluptate praesentium</h2>
            <div class="article__img">
              <img class="img" src="../../assets/img/blogDetails/blogDetails_3.jpg" alt="">
            </div><!-- /.blogPost__img -->
            ...
            <div class="article__img">
              <img class="img" src="../../assets/img/blogDetails/blogDetails_4.jpg" alt="">
            </div><!-- /.blogPost__img -->           
            <p>Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</p>
